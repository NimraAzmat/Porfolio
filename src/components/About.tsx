        ...
        >
          ...
          <motion.div className="space-y-6" variants={staggerContainer}>
            <motion.p className="text-lg text-gray-600" variants={fadeInUp}>
              Hi, I'm Nimra Azmat, a passionate Full Stack Developer.
              As an independent and self- motivated individual, I have gained 
              valuable experience in developing end-to-end projects deploying them on 
              cloud platforms, and working with various technologies.
            </motion.p>
            ...
            <motion.p className="text-lg text-gray-600" variants={fadeInUp}>
              ...
              build scalable solutions that are secure, fast, and user-friendly.
            </motion.p>
